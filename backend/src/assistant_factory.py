...
Логика повторяет кеширование в экспериментах (Claude/retrieval_experiment.py),
чтобы прод и эксперименты вели себя одинаково. Кеш можно собрать заранее скриптом
