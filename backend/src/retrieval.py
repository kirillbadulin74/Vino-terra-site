    ...
    def __init__(
        ...
        *,
        ...
        if client is None:
            ...
            client_kwargs = {}
            # Генерация и embeddings могут обслуживаться разными провайдерами.
            # EMBEDDING_* имеет приоритет; OPENAI_* сохранён для обратной
            # совместимости с исходным дипломным проектом.
